<template>
	...
	<div :style="{height:'550px',width:'680'}" id="chart-panel" class="maps" ref="myxiasha"></div>
	...
	export default {
		...
		data(){
			return{
				...
				max:0,
				geoCoordMap:{
					'亚泰基地':[119.6492416192,29.0820044046],
		...
		getlist(){
			this.$api.getNumberByCommunity().then(res=>{
				var data=res.data;
				var list=[]
				var valueList=[];
				data.forEach((e,i,a)=>{
